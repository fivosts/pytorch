...
Tensor CPUType::grid_sampler_2d(const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
#ifdef BUILD_NAMEDTENSOR
    ...
    return at::native::grid_sampler_2d_cpu(input, grid, interpolation_mode, padding_mode);
}
std::tuple<Tensor,Tensor> CPUType::grid_sampler_2d_backward(const Tensor & grad_output, const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
#ifdef BUILD_NAMEDTENSOR
...
#endif
    const OptionalDeviceGuard device_guard(device_of(grad_output));
    return at::native::grid_sampler_2d_backward_cpu(grad_output, input, grid, interpolation_mode, padding_mode);
}
Tensor CPUType::grid_sampler_3d(const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
#ifdef BUILD_NAMEDTENSOR
    if (input.has_names() || grid.has_names()) {
...
#endif
    const OptionalDeviceGuard device_guard(device_of(input));
    return at::native::grid_sampler_3d_cpu(input, grid, interpolation_mode, padding_mode);
}
std::tuple<Tensor,Tensor> CPUType::grid_sampler_3d_backward(const Tensor & grad_output, const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
#ifdef BUILD_NAMEDTENSOR
    if (grad_output.has_names() || input.has_names() || grid.has_names()) {
...
#endif
    const OptionalDeviceGuard device_guard(device_of(grad_output));
    return at::native::grid_sampler_3d_backward_cpu(grad_output, input, grid, interpolation_mode, padding_mode);
}
...
static auto& registerer = globalATenDispatch()
  ...
  .registerOp<Tensor (const Tensor &, const Tensor &, int64_t, int64_t)>(Backend::CPU, "aten::grid_sampler_2d(Tensor input, Tensor grid, int interpolation_mode, int padding_mode) -> Tensor", &CPUType::grid_sampler_2d)
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, const Tensor &, const Tensor &, int64_t, int64_t)>(Backend::CPU, "aten::grid_sampler_2d_backward(Tensor grad_output, Tensor input, Tensor grid, int interpolation_mode, int padding_mode) -> (Tensor, Tensor)", &CPUType::grid_sampler_2d_backward)
  .registerOp<Tensor (const Tensor &, const Tensor &, int64_t, int64_t)>(Backend::CPU, "aten::grid_sampler_3d(Tensor input, Tensor grid, int interpolation_mode, int padding_mode) -> Tensor", &CPUType::grid_sampler_3d)
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, const Tensor &, const Tensor &, int64_t, int64_t)>(Backend::CPU, "aten::grid_sampler_3d_backward(Tensor grad_output, Tensor input, Tensor grid, int interpolation_mode, int padding_mode) -> (Tensor, Tensor)", &CPUType::grid_sampler_3d_backward)
